...
import axios from "axios";
 ...
 useEffect(() => {
    axios
      .get("http://localhost:8080/customers/category")
  ...
  { id: "s1", name: "Laptops" },
  { id: "s2", name: "Smartphones" },
  { id: "s3", name: "Accessories" },
  { id: "s4", name: "Gaming" },
  { id: "s5", name: "Wearables" },
  { id: "s6", name: "Power Devices" },
];
const mergedCategories = [...staticCategories, ...categories];
...
>
  <button className="text-gray-700 hover:text-blue-500 font-medium flex items-center gap-1">
    Categories <ChevronDown size={14} />
  </button>

  {showDropdown && (
    <ul className="absolute top-full left-0 mt-2 w-48 bg-white border rounded-md shadow-md z-50">
