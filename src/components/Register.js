...
//                               <input type="radio" name="gender" value="male" className="form-radio text-indigo-600" />
//                               <span className="ml-2">Male</span>
//                             </label>
//                             <label className="inline-flex items-center mr-4">
//                               <input type="radio" name="gender" value="female" className="form-radio text-indigo-600" />
//                               <span className="ml-2">Female</span>
//                             </label>
//                             <label className="inline-flex items-center">
//                               <input type="radio" name="gender" value="other" className="form-radio text-indigo-600" />
